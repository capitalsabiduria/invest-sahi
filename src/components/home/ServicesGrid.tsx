...
const RETIREMENT_SLUGS = new Set(['national-pension-system', 'sovereign-gold-bonds', 'fixed-deposits', 'investment-insurance']);
...
export const SERVICES = [
  ...
  { nameKey: 'services.s4.name', amountKey: 'services.s4.amount', descKey: 'services.s4.desc', iconName: 'GraduationCap', iconColor: 'text-saffron', iconBg: 'bg-saffron-light', slug: 'national-pension-system' },
  { nameKey: 'services.s5.name', amountKey: 'services.s5.amount', descKey: 'services.s5.desc', iconName: 'Heart', iconColor: 'text-green', iconBg: 'bg-green-light', slug: 'public-provident-fund' },
  { nameKey: 'services.s6.name', amountKey: 'services.s6.amount', descKey: 'services.s6.desc', iconName: 'Umbrella', iconColor: 'text-blue', iconBg: 'bg-blue-light', slug: 'sukanya-samriddhi-yojana' },
  { nameKey: 'services.s7.name', amountKey: 'services.s7.amount', descKey: 'services.s7.desc', iconName: 'Star', iconColor: 'text-saffron', iconBg: 'bg-saffron-light', slug: 'sovereign-gold-bonds' },
  ...
  { nameKey: 'services.s10.name', amountKey: 'services.s10.amount', descKey: 'services.s10.desc', iconName: 'Wallet', iconColor: 'text-saffron', iconBg: 'bg-saffron-light', slug: 'mudra-loans' },
          ...
          {SERVICES.map((svc, i) => {
            ...
            return (
              <RevealSection key={i} delay={i * 0.05}>
                <Link
                  to={
                    RETIREMENT_SLUGS.has(svc.slug)
                      ? `/${currentLang}/services?expand=${svc.slug}#retirement`
                      : `/${currentLang}/services?expand=${svc.slug}#family`
                  }
